        ...
        {
            {
                ...
                json.Is("{\"ClassName\":\"System.Exception\",\"Message\":\"ABC\",\"Source\":null,\"StackTrace\":null,\"InnerException\":null}");
            }
            {
                var ex = new Exception("ABC");
        ...
        {
            {
                ...
                var json = JsonSerializer.ToJsonString(ex);
                json.Is("{\"ClassName\":\"Utf8Json.Tests.FooException\",\"Bar\":100,\"Message\":\"BCD\",\"Source\":null,\"StackTrace\":null,\"InnerException\":null}");
            }
            {
        ...
        {
            {
                ...
                var json = JsonSerializer.ToJsonString(ex);
                json.Is("{\"ClassName\":\"System.Exception\",\"Message\":\"ABC\",\"Source\":null,\"StackTrace\":null,\"InnerException\":{\"ClassName\":\"Utf8Json.Tests.FooException\",\"Bar\":100,\"Message\":\"BCD\",\"Source\":null,\"StackTrace\":null,\"InnerException\":null}}");
            }
            {
                var ex = new Exception("ABC", new FooException { Bar = 100 });
